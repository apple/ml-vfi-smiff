...
from .FilterInterpolationLayer2 import FilterInterpolationLayer2,WeightLayer, PixelValueLayer,PixelWeightLayer,ReliableWeightLayer

class FilterInterpolationModule2(Module):
    def __init__(self):
        super(FilterInterpolationModule2, self).__init__()
        # self.f = FilterInterpolationLayer()

    def forward(self, input1, input2, input3):
        return FilterInterpolationLayer2.apply(input1, input2, input3)
